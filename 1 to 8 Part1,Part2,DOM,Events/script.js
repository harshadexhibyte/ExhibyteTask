...
// const info =
//   "I'am" + " " + firstname + " ,a " + (year - bod) + " years old " + job + "!";
// console.log(info);
...
const merridJensi = jensi;
merridJensi.lastName = "jain";
console.log("Before Marriage Jensi", jensi);
console.log("After Marriage :", merridJensi);
...
const jensycopy = Object.assign({}, jensi2);
jensycopy.lastName = "jain";
console.log("Before Marriage Jensi", jensi2);
console.log("After Marriage :", jensycopy);
console.log("");
